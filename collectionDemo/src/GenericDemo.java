...
public class GenericDemo {
    public static void main(String[] args) {
        GenericClass<String> fx1 = new GenericClass<>();
        fx1.setId(1);
        fx1.setT("zhangsan");
        fx1.show();
        System.out.println("--------------");
        GenericClass<Integer> fx2 = new GenericClass<>();
        fx2.setId(2);
        fx2.setT(111);
        fx2.show();
        System.out.println("--------------");
        GenericClass<Person> fx3 = new GenericClass<>();
        fx3.setId(3);
        fx3.setT(new Person("姬大德",22));
        fx3.show();
        System.out.println(fx3.getT());
        System.out.println("--------------");

        GenericInterfaceSub genericInterfaceSub = new GenericInterfaceSub();
        genericInterfaceSub.test2("hello world");
        System.out.println("--------------");
